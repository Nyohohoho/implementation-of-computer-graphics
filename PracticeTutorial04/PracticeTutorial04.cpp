...
int main(void)
{
	...
	// glm::mat4 Model = glm::translate(glm::mat4(), glm::vec3(-1.5f, 0.0f, 0.0f));
	...
	for (int i = 0; i < 12 * 3; i++) {
		g_color_buffer_data[3 * i + 0] = (GLfloat)rand() / (GLfloat)RAND_MAX; // red color here;
		g_color_buffer_data[3 * i + 1] = (GLfloat)rand() / (GLfloat)RAND_MAX; // green color here;
		g_color_buffer_data[3 * i + 2] = (GLfloat)rand() / (GLfloat)RAND_MAX; // blue color here;
	}
	*/
	...
	// Translate Model matrix
	glm::mat4 Model_tri = glm::translate(glm::mat4(), glm::vec3(1.5f, 0.0f, 0.0f));
	// Our ModelViewProjection : multiplication of our 3 matrices
	glm::mat4 MVP_tri = Projection * View * Model_tri; // Remember, matrix multiplication is the other way around
